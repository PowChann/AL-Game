        ...
        >
          ...
          <View className="items-center mb-8">
            <Animated.View
              ...
              className="w-20 h-20 bg-primary/10 rounded-[24px] items-center justify-center border border-primary/20 mb-3"
            >
              <Ionicons name="game-controller" size={44} color="#4A9FD4" />
            </Animated.View>
          ...
          <View className="h-[1px] bg-borderLight w-full mb-8" />
          ...
          <View className="gap-y-4 mb-6">
            ...
            <View>
              ...
              <View
                className={`flex-row items-center bg-surface h-[52px] rounded-[16px] px-4 border ${
                  emailFocused ? 'border-primary' : 'border-borderLight'
                }`}
              >
            ...
            <View>
              ...
              <View
                className={`flex-row items-center bg-surface h-[52px] rounded-[16px] px-4 border ${
                  passwordFocused ? 'border-primary' : 'border-borderLight'
                }`}
              >
          ...
          <View className="flex-row items-center my-4 justify-center">
            <View className="h-[1px] bg-borderLight flex-1" />
          ...
          <Button
            ...
            size="lg"
            variant="secondary"
            icon={<Ionicons name="logo-google" size={18} color="#4A9FD4" />}
            className="mb-8"
          />

          {/* Register Link */}
          <View className="flex-row justify-center items-center mt-auto">
            <Text className="text-gray-500 font-body text-sm mr-1.5">
              Chưa có tài khoản?
            </Text>
